...
> If the `git clone` fails, it's possible your SSH key was not setup correctly. Double check the [setup instructions][lesson-setup], and head to Mattermost for help. 
