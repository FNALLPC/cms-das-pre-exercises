...
```
{: .output}
If you do not have the first attribute line listed above, you probably did not finish the VO registration in the [setup]({{ page.root }}{% link setup.md %}). Double check this first, and otherwise reach out on Mattermost.
