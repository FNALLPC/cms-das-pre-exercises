...
> If the `git clone` fails, it's possible your SSH key was not setup correctly. Double check the [setup instructions]({{ relative_root_path }}{% link setup.md %}), and head to Mattermost for help. 
